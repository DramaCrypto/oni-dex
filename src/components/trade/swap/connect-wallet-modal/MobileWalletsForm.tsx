...
const MobileWalletsForm: FC<Props> = (props) => {
  ...
  return (
    <Box className='flex flex-col p-[16px] flex-wrap justify-center bg-black rounded-[24px] z-10'>
      ...
      <Box className='flex flex-wrap'>
        {
          ['WalletConnect', 'Trust Wallet', 'Coinbase Wallet', 'OKX Wallet', 'Xaman', 'Install radix Wallet'].map((el) => (
...
export default MobileWalletsForm
